...
def predict_AQI(T,TM,Tm,SLP,H,VV,V,Vm,city):
    ...
    if city=='Banglore':
      pickle_in = open("Random_forest_regressor_bngl.pkl","rb")
    ...
    if city=='Chennai':
      pickle_in = open("Random_forest_regressor_chennai.pkl","rb")
      random_forest_regressor=pickle.load(pickle_in)
    ...
    if city=='Goa':
      pickle_in = open("Random_forest_regressor_Goa.pkl","rb")
      random_forest_regressor=pickle.load(pickle_in)
    ...
    if city=='Hyderabad':
      pickle_in = open("Random_forest_regressor_hyd.pkl","rb")
      random_forest_regressor=pickle.load(pickle_in)
    ...
    if city=='Mumbai':
      pickle_in = open("Random_forest_regressor_mumbai.pkl","rb")
      random_forest_regressor=pickle.load(pickle_in)  
    ...
    if city=='New Delhi':
      pickle_in = open("Random_forest_regressor_del.pkl","rb")
      random_forest_regressor=pickle.load(pickle_in)
    ...
    if city=='Vishakapatnam':
      pickle_in = open("Random_forest_regressor_Vizag.pkl","rb")
      random_forest_regressor=pickle.load(pickle_in)
